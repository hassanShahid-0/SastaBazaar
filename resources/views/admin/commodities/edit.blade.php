    ...
    <div class="col-lg-7" data-aos="fade-up">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-0 pt-4 ps-4">
                <h5 class="fw-bold mb-0"><i class="bi bi-pencil-square me-2 text-warning"></i>Edit: {{ $commodity->name }}</h5>
            </div>
                ...
                <form action="{{ route('admin.commodities.update', $commodity) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="urdu_name" id="urdu_name"
                               ...
                               value="{{ old('urdu_name', $commodity->urdu_name) }}" dir="rtl">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="unit" id="unit"
                            ...
                            @foreach(['kg','gram','litre','dozen','piece','bag (50kg)','maund'] as $u)
                                <option value="{{ $u }}" {{ old('unit', $commodity->unit) == $u ? 'selected' : '' }}>{{ $u }}</option>
                            @endforeach
                        </select>
