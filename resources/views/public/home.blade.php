...
<div x-data="{
    ...
    <section class="hero-banner">
        <div class="container text-center position-relative z-1" data-aos="fade-down">
            <span class="badge bg-white bg-opacity-25 text-white border border-white border-opacity-25 px-3 py-2 rounded-pill mb-3">
                        ...
                        <div class="row g-2 align-items-center">
                            <div class="col-md-7">
                                <div class="input-group">
                                    <span class="input-group-text bg-transparent border-0 fs-5" style="color: #050606;"><i class="bi bi-search"></i></span>
                                    <input type="text" class="form-control border-0 shadow-none ps-0 sb-search-input"
                                        style="background-color: #ffffff; color: #000000;"
                                        x-model="search"
                                        placeholder="Search items (e.g. Sugar, Flour, چینی)...">
                                    <button class="btn" x-show="search" @click="search = ''" type="button" style="color: #36383a;">
                            ...
                            <div class="col-md-5">
                                <form method="GET" action="{{ route('home') }}" class="d-flex align-items-center gap-2">
                                    <input type="date" name="date" class="form-control form-control-sm border-0 fw-medium"
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4" data-aos="fade-up">
                ...
                <div class="btn-group btn-group-sm bg-white shadow-sm p-1 rounded-pill border" role="group">
                    <button type="button" class="btn rounded-pill px-3"
                        ...
                        :style="viewMode === 'table' ? '' : 'color: #495057;'"
                        @click="viewMode = 'table'">
                        <i class="bi bi-table me-1"></i> Table View
                    </button>
                    <button type="button" class="btn rounded-pill px-3"
                        :class="viewMode === 'cards' ? 'btn-primary' : 'btn-light'"
                        :style="viewMode === 'cards' ? '' : 'color: #495057;'"
